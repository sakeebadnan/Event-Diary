...
?>
      <div class ="CRform">
          <form action="" method="post" name="customerReg" id= "cr">           
              ...
              <input id="ad" name="Address"  placeholder="Address" type="text" tabindex="5"><br>
              <input id="ct" type="text"  name="City" placeholder="City" onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode==32)" tabindex="6"><br>
              <input id="st" name="State"  placeholder="State" type="text" onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode==32)" tabindex="7"><br>
              <input id="co" name="Country"  placeholder="Country" type="text" onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode==32)" tabindex="8"><br>
              <input id="pc" type="text"  name="PostalCode" placeholder="Postal Code" tabindex="9"><br>
              <input id="ph" name="Phone"  placeholder="Phone Number" type="phone"  tabindex="10"><br>
